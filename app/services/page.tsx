...
export const metadata = {
  title: "บริการส่งน้ำแข็ง ปทุมธานี - เช่าถังน้ำแข็ง | บริการส่งน้ำแข็งในงาน",
  description:
    "บริการส่งน้ำแข็งในปทุมธานี สำหรับร้านค้า, ร้านอาหาร, คาเฟ่, ตลาด และการเช่าถังน้ำแข็ง พร้อมน้ำแข็ง รวมถึงบริการส่งน้ำแข็งในงาน Event",
  keywords: [
    "ร้านน้ำแข็ง ใกล้ ฉัน",
    "โรงน้ำแข็ง",
    "เช่าถังน้ำแข็ง ใกล้ฉัน",
    "น้ำแข็งแห้ง ใกล้ฉัน",
    "สั่งน้ำแข็ง พร้อมถัง ใกล้ฉัน",
    "น้ำแข็งกระสอบ ใกล้ฉัน",
    "โรงน้ำแข็งที่ใกล้ที่สุด",
  ],
  robots: "index, follow",
};
